...
public class OmniMovementComponent : MonoBehaviour {
    ...
    // Trying something for player direction in Omni:
    public static OmniMovementComponent instance;
...
#pragma warning restore 0414
    ...
    protected float ComputeAngleBetweenControllerAndCamera()
    {
        ...
        // Debug.Log("this is the adjusted Omni Yaw: " + adjustedOmniYaw);
        // Debug.Log("This is the current Omni Yaw: " + currentOmniYaw);
        // Debug.Log("This is the transform angle from the forward rotation vector: " + transform.rotation.eulerAngles.y);
    ...
    public void GetOmniInputForCharacterMovement()
    {
        ...
        // Debug.Log("This is the angle of rotation from the Omni Ring to camera: " + angleBetweenOmniAndCamera);

        float forwardRotation = 0f;
        float ringAngleInGameWorld = 0f;

        //keep within bounds (0, 360)
        if (currentOmniYaw > 360f) currentOmniYaw -= 360f;
        if (currentOmniYaw < 0f) currentOmniYaw += 360f;

        // Debug.Log("This is the omni Ring angle: " + currentOmniYaw);

        // //Try somethign new, from Zach:
        // motionData.RingAngle = Move_Look_VR.instance.omniRing_transform.transform.eulerAngles.y;
        //
        // if (Move_Look_VR.instance.omniRing_transform.transform.eulerAngles.y != currentOmniYaw)
        ...
        //Calculate ring angle in gameworld
        ringAngleInGameWorld = (currentOmniYaw - omniOffset + transform.rotation.eulerAngles.y);
        PlayerPrefs.SetFloat("ringAngleInGameWorld", ringAngleInGameWorld);
        // Debug.Log("Ring angle in real world: " + ringAngleInGameWorld);
        ...
        //Vector3 movementInputVector = new Vector3(dummyForward.x * hidInput.y, 0, dummyForward.z * hidInput.y);
