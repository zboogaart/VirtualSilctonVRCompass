...
public class OmniController_Example : MonoBehaviour {
    ...
    //Testing to fix offset in start-up direction
    // public Transform Reference_Frame;
    // public GameObject game_object;
    // public GameObject forwardIndicatorTest;
    ...
    void CorrectSpawnForward()
    {
        ...
        // cameraRef.transform.rotation.eulerAngles.y=0f;
        // m_CharacterController.transform.rotation.eulerAngles.y=0f;
        // Vector3 resultRotation_test = new Vector3(0.0f, 0.0f, 0.0f);
        //
        // Reference_Frame.transform.Rotate(resultRotation_test,Space.World);
        // // game_object.transform.Rotate(resultRotation_test);
        // forwardIndicatorTest.transform.Rotate(resultRotation_test,Space.World);
    ...
    void UseOmniInputToMovePlayer()
    {
        ...
        if (MovementComponent.GetForwardMovement() != Vector3.zero)
            ...
            // Debug.Log("this is the forward movement: "+ MovementComponent.GetForwardMovement());
